...
"Comomonas testosteroni_C" = "#46f0f0",
...
# Plot
```{r}
cols <- c("NA" = "#FF0000", "Citrobacter_B" = "#3cb44b", "Pseudomonas_E" = "#ffe119", "Bordatella" = "#4363d8", "Microvirga" = "#000000", "Paracoccus" = "#911eb4", "Comomonas" = "#46f0f0", "Morganella" = "#bcf60c", "Cupriavidus" = "#fabebe", "Sphingobium" = "#008080", "Aeromonas" = "#e6beff", "Agrobacterium" = "#9a6324", "Stenotrophomonas" = "#fffac8", "Sphingobacterium" = "#800000", "Kluyvera" = "#aaffc3", "Acinetobacter" = "navyblue", "Azorhizobium" = "#3294c1", "Azospirillum" = "#D35400", "Chromobacterium" = "grey", "Elizabethkingia" = "#A3E4D7", "Enterococcus" = "orange", "Escherichia" = "#cfb189", "Hafnia" = "#29522F", "Listeria" = "#D1D19B", "Phyllobacteria" = "#74A172", "Staphylococcus" = "#F56782")
...
p <- plot_bar_2(PHY_genus_filtered, fill = "genus") + 
  ...
  labs(title = "Bacterial composition",
       subtitle = "Synthetic community (>1 % genera)",
       y = "Relative abundance") +
  scale_y_continuous(expand = c(0,0)) +
  scale_x_discrete(labels = c(
    "bcAd1023T" = "0.2 µg/ml TC\n15 °C",
    "bcAd1037T" = "20 µg/ml SMZ\n25 °C",
    "bcAd1039T" = "20 µg/ml SMZ\n25 °C",
    "bcAd1046T" = "0.02 µg/ml TC\n37 °C",
    "bcAd1063T" = "no ab\n37 °C")) +
  theme(
        ...
        axis.text.x = element_text(size = 10, hjust = 1, color = "black", vjust = 1, angle = 35),
        plot.title = element_text(size = 20),
        plot.subtitle = element_text(size = 14)) + 
  scale_fill_manual(values=c(cols))
p

ggsave(filename = "plots/HAMBI_sylph_>1_percent.png",
       width = 8, height = 6, dpi = 300, units = "in", device="png", scale = 1)

ggsave(filename = "plots/HAMBI_sylph_>1_percent.svg", 
...
p <- ggplot(MAG_count_class_sample, aes(x = class, y = n, fill = Sample)) + 
  geom_bar(stat = "identity") + scale_fill_manual(values = c(cols)) + theme_minimal() +
  ggtitle("MAGs by HiFi MAG Pipeline (class)") +
  scale_y_continuous(expand = c(0,0)
                     #, limits = c(0,50)
                     ) +
  theme(
